...
export function ProfileScreen() {
  const { profile, nutritionalNeeds, streakData, dailyHistory } = useUser();

  if (!profile || !nutritionalNeeds) {
    return (
      <div className="relative h-full bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 overflow-hidden p-6 flex items-center justify-center">
