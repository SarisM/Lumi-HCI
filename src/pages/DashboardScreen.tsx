...
export function DashboardScreen() {
  const { nutritionalNeeds, waterGlasses, addWater, getTotalIntake, mealIntakes, streakData, userName } = useUser();
      ...
      <div className="flex items-center justify-center mb-8">
        <div className="relative">
          ...
          <div className="relative w-40 h-40 bg-white/80 backdrop-blur-xl rounded-full shadow-2xl flex items-center justify-center border-4 border-white/50">
            ...
            >
              <span className="text-white">{Math.min(totalBalance, 100)}%</span>
            </motion.div>
          </div>
        </div>
      </div>
